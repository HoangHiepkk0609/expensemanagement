    ...
    <View style={styles.container}>
      <View style={styles.momoBanner}>
        ...
        <Text style={styles.momoText}>
          <Text style={styles.momoBold}>Thanh toán bằng MoMo</Text> để bảo cáo
          chính xác hơn
        </Text>
      </View>
      ...
      <View style={styles.infoBanner}>
        ...
        <Text style={styles.infoText}>
          Số liệu chi tiêu khác với mức giao dịch mà ngân hàng nhà nước quy
          định. <Text style={styles.infoLink}>Xem chi tiết</Text>
        </Text>
      </View>
    </View>
  );
